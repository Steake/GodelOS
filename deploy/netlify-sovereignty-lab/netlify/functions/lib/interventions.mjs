...
export function intervene(source,ablation){
 ...
 if(ablation==='memory'){
  ...
  m.living=null;
  Object.assign(m,{memories:[],focus_history:[],attention_control:null,last_input:null,workspace:null,last_trace:null,thoughts:[],self_observation:null,revisions:[],outbox:[]});
